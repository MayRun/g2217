...
$word_arrays_arr = array( 
	array(".", "sdsdsdsdsdsdsdbigword1"),
    array("word2.xcxcxccxcxcxcxcxcccxcxcxcx1.", "b", "m", "askjdjlkajsdlkjlaksjdkljalskdjlk"),
    array("word3.1", "bigword3.2", "moreword3.3", "word3.4", "bigword3.5", "moreword3.6"),
    array("word4.1", "zxzxzxzxzxzxbigword", "moreword4.3", "sd", "s", "s"),
    array("word5.1"),
	array("w"),
    array("w"),
    array("w", "b", "."));
